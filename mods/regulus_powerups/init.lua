    ...
    on_step=function(self,dtime,moveresult)
        ...
        if moveresult.collides then
            for _,collision in pairs(moveresult.collisions) do
                if collision.type=="object" collision.object and (collision.object:get_luaentity().name=="regulus_mobs:boss" or collision.object:get_luaentity().name=="regulus_mobs:enemy1") and self.object and self.object:get_velocity() then
